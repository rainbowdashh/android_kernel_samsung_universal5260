...
#define FIMC_IS_S5K6B2_SETF			"setfile_6b2.bin"
...
#define AK7343_SLAVE_ADDR 0x18
#define AK7343_WRITE_BIT 0x0
#define AK7343_READ_BIT 0x1
#define AK7343_ADDR 170
#define AK7343_PID_ADDR 7
#define AK7343_DATA 85
...
struct fimc_is_i2c_gpio {
	struct exynos_sensor_pin *scl;
	struct exynos_sensor_pin *sda;
};
...
int fimc_is_sec_get_module_name(void);
int fimc_is_sec_set_module_name(int module);
...
int fimc_is_sec_fw_sel(struct device *dev, struct exynos_platform_fimc_is_sensor *pdata, char *fw_name, char *setf_name, int isSysfsRead);
...
int fimc_is_sec_gpio_enable(struct exynos_platform_fimc_is_sensor *pdata, char *name, bool on);
...
int fimc_is_sec_ak7343_get_ack(struct fimc_is_i2c_gpio *ak7343);
int fimc_is_sec_ak7343_output(struct fimc_is_i2c_gpio *ak7343, unsigned char data);
int fimc_is_sec_ak7343_input(struct fimc_is_i2c_gpio *ak7343, unsigned char *data);
void fimc_is_sec_ak7343_start_bit(struct fimc_is_i2c_gpio *ak7343);
void fimc_is_sec_ak7343_stop_bit(struct fimc_is_i2c_gpio *ak7343);
int fimc_is_sec_ak7343_read(struct fimc_is_i2c_gpio *ak7343, unsigned char addr, unsigned char *data);
int fimc_is_sec_ak7343_write(struct fimc_is_i2c_gpio *ak7343, unsigned char addr, unsigned char data);
unsigned char fimc_is_sec_read_ak7343_default_pid(struct device *dev, struct exynos_platform_fimc_is_sensor *pdata);
unsigned char fimc_is_sec_get_ak7343_default_pid(void);
